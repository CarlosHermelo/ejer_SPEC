...
|---|---|---|---|
| Endpoint `GET /personas` existe | Probar `GET /personas` | [AGENTE] | Pending |
| El endpoint devuelve lista JSON | Crear datos y verificar respuesta | [AGENTE] | Pending |
| El orden es correcto | Crear personas con distintas fechas y verificar orden por `fecha_alta` desc, `id` desc | [AGENTE] | Pending |
